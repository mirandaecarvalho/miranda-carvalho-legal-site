            ...
            <Card key={index} className="p-8 bg-card hover:shadow-lg transition-all duration-300 text-center">
              <div className="mb-6">
                <img 
                  src={member.photo} 
                  alt={member.name}
                  className="w-32 h-32 rounded-full mx-auto object-cover border-4 border-legal-gold"
                />
              </div>
        ...
        <div className="text-center mt-12">
          <Card className="max-w-2xl mx-auto p-8 bg-legal-light border-legal-gold border">
            ...
            <p className="font-montserrat text-muted-foreground leading-relaxed">
              Além dos sócios-fundadores, nosso escritório conta com uma equipe qualificada de 
              advogados associados, estagiários e assistentes jurídicos, todos comprometidos 
              com a excelência no atendimento e na prestação de serviços jurídicos.
            </p>
          </Card>
        </div>
      </div>
